...
Crisp.prototype = {
  ...
  get : function(resource, query) {
    ...
    return new __Promise(function(resolve, reject) {
      self._request(
        resource, "GET", query, {}, resolve, reject
      );
    });
  },
  ...
  head : function(resource, query, body) {
    ...
    return new __Promise(function(resolve, reject) {
      self._request(
        resource, "HEAD", query, {}, resolve, reject
      );
    });
  },
  ...
  delete : function(resource, query, body) {
    ...
    return new __Promise(function(resolve, reject) {
      self._request(
        resource, "DELETE", query, {}, resolve, reject
      );
    });
  },
    ...
    request({
      ...
      try {
        ...
        if (error || response.statusCode >= 400) {
          return reject({
            reason  : "error",
            message : (data.reason || "Request could not be submitted."),

            data    : {
              namespace : "status",
              message   : ("got status: '" + response.statusCode + "'")
            }
          });
        }
        ...
        return reject({
          reason  : "error",
          message : "Received invalid response body from server.",

          data    : {
            namespace : "body",
            message   : ("got body: '" + response.body + "'")
          }
        });
      }
    });
