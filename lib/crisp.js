...
Crisp.DEFAULT_REALTIME_EVENTS = [
    ...
    "browsing:action:started",
    "browsing:action:stopped",
    "browsing:stream:mirror",
    "browsing:stream:mouse",
    "browsing:stream:click",
    "browsing:stream:tab",
    "browsing:stream:scroll",
    "browsing:debug:started",
    "browsing:debug:stopped",
    "browsing:debug:executed",
    "browsing:debug:stream",
