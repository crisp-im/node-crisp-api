...
function PluginSubscriptions(crisp) {
  ...
  this.getSubscriptionDetails = function(websiteId, pluginId) {
    return crisp.get(crisp._prepareRestUrl(["plugins", "subscription", websiteId, pluginId]));
  };
  ...
  this.saveSubscriptionSettings = function(websiteId, pluginId, settings) {
    return crisp.get(crisp._prepareRestUrl(["plugins", "subscription", websiteId, pluginId, "settings"]), {}, settings);
  };
}
