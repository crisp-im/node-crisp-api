...
function WebsitePeople(crisp) {
  ...
  this.getPeopleSubscriptionStatus = function(websiteId, peopleId) {
    return crisp.get(crisp._prepareRestUrl(["website", websiteId, "people", "subscription", peopleId]), {}, {});
  }
  ...
  this.updatePeopleSubscriptionStatus = function(websiteId, peopleId, data) {
    return crisp.patch(crisp._prepareRestUrl(["website", websiteId, "people", "subscription", peopleId]), {}, data);
  }
}
