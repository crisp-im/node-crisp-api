...
function WebsitePeople(crisp) {
  ...
  this.createNewPeopleProfile = function(websiteId, params) {
    return crisp.get(crisp._prepareRestUrl(["website", websiteId, "people", "profile"]), {}, params);
  };
  ...
  this.checkPeopleProfileExists = function(websiteId, peopleId) {
    return crisp.head(crisp._prepareRestUrl(["website", websiteId, "people", peopleId]), {}, {});
  };
  ...
  this.listPeopleConversations = function(websiteId, peopleId, page) {
    return crisp.get(crisp._prepareRestUrl(["website", websiteId, "people", "conversation", peopleId, "list", page]), {}, {});
  };
